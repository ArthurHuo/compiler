...
public interface Stmt extends SyntacticElement {
	...
	Stmt {//xiu gai guo xin jia de
		public final Expr expr;
//		public final ArrayList<Constant> constants;
		public final ArrayList<Stmt> stmts;

		public Case(Expr values, List<Stmt> statements,
				Attribute... attributes) {
			super(attributes);
			this.expr = values;
...
//		public final ArrayList<Constant> constants;
		...
		public Default(List<Stmt> statements,
				Attribute... attributes) {
			super(attributes);
//			this.expr = values;
			this.stmts = new ArrayList<Stmt>(statements);
...
//		public final ArrayList<Constant> constants;
		...
		public Switch(Expr values, List<Stmt> statements,
				Attribute... attributes) {
			super(attributes);
			this.expr = values;
			this.stmts = new ArrayList<Stmt>(statements);
