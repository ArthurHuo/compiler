...
public interface Expr extends SyntacticElement {
	...
	public enum BOp {
		...
		INSTANCEOF{
			public String toString(){// xiu gai guo xin jia de
				return "is";
			}
		}
	};
	...
	public static class Isof extends SyntacticElement.Impl implements Expr {// xiu gai guo xin jia de
		 ...
		 * @param attributes
		 */
		public Isof(BOp op, Expr lhs, Type rhs, Attribute... attributes) {
			super(attributes);
			this.op = op;
			this.lhs = lhs;
			this.rhs = rhs;
		 ...
		 * @param attributes
		 */
		public Isof(BOp op, Expr lhs, Type rhs,
				Collection<Attribute> attributes) {
			super(attributes);
			this.op = op;
			this.lhs = lhs;
